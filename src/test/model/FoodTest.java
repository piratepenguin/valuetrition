...
class FoodTest {
    ...
    Food banana = new Food("banana", 2, 100, 24, 0, 1); // very bad value
    Food rice = new Food("rice", 5.0, 3000, 700, 11, 25); // extremely good value
    Food beef = new Food("beef", 2, 450, 0, 15, 70); // medium value
    Food apple = new Food("apple", 0.75, 100, 24, 0, 1); // bad value
    Food milk = new Food("milk", 6, 2000, 180, 65, 180); // good value
    Food nuts = new Food("nuts", 2.5, 600, 5, 50, 10); // medium value
    ...
    void getterMethodTests() {
        ...
        assertEquals("none", milk.getPrimaryType());
    }
    @Test
    void editFoodTest() {
