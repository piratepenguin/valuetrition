...
//    Log log;
//    Log log2;
//    Meal blueberryMeal = new Meal(new Food("blueberry", 100,2, 100, 24, 0, 1), 300, "JAN002000"); // very bad value
//    Meal beefMeal = new Meal(new Food("beef", 200, 3, 450, 10, 30, 70), 200, "JAN002000"); // low value
//    Meal riceMeal = new Meal(new Food("rice", 3000,6.0, 3000, 700, 11, 25), 500, "JAN012000"); // extremely good value
//
//
//    @BeforeEach
//    void runBefore() {
//        log = new Log();
//        log2 = new Log();
//        log.logMeal(blueberryMeal);
//        log.logMeal(beefMeal);
//        log.logMeal(riceMeal);
//    }
//
//    @Test
//    void getLogForDayTest() {
//        try {
//            MealList mealList1 = log.getLogForDay("JAN002000");
//            Meal observedBlueberryMeal = mealList1.get(0);
//            Meal observedBeefMeal = mealList1.get(1);
//            MealList mealList2 = log.getLogForDay("JAN022000");
